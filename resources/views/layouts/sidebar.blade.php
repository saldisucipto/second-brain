    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/" class="inline-flex items-center ">
            <img x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                src="/logo.png" alt="MySecondBrain" class="h-20 w-20 rounded-md object-cover" />
            <span x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                class="text-3xl leading-8 font-semibold text-gray-800 dark:text-white/90 whitespace-nowrap">
                My Second <br> Brain
            </span>

            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                src="/logo.png" alt="MySecondBrain" class="h-16 w-16 rounded-md object-cover" />
        </a>
    </div>
